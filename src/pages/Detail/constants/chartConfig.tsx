...
export const CHART_CONFIG: ChartDefinition[] = [
  {
    id: "donchian",
    label: "布林", // 這裡用戶原本寫布林但對應的是唐奇安
    title: "唐奇安通道策略",
    docContent: donchianDoc,
    timezoneAdvice: "唐奇安通道在日線 (D1) 的有效性最高，標準參數 (20) 能過濾多數噪音，捕捉大波段突破。若切換至短線，需搭配更高週期的趨勢進行過濾。",
  ...
  },
  {
    ...
    title: "均線與缺口策略",
    docContent: maDoc,
    timezoneAdvice: "MA 策略在日線 (D1) 最能體現「趨勢的力量」。在週線 (W1)，MA 20 (月線) 具有極強的防禦屬性。若在 1 小時 (H1) 看到跳空缺口，應先檢查 D1 是否處於關鍵支撐位，避免在長線壓力區追多短線缺口。",
  ...
  },
  {
    ...
    title: "EMA趨勢策略",
    docContent: emaDoc,
    timezoneAdvice: "EMA 策略在日線 (D1) 提供穩定的中長線指南。若要在 H1 進場，請務必先確認 D1 的價格是否在 EMA 60 或 SMA 200 支撐位附近。",
  ...
  },
  {
    ...
    docContent: atrDoc,
    timezoneAdvice: "ATR Supertrend 策略在日線 (D1) 追蹤趨勢非常有效。若要在短線使用，請務必搭配較大時區的 EMA (如 D1 的 EMA 50) 作為方向過濾，避免在盤整時頻繁被洗出場。",
  ...
  },
  {
    ...
    title: "OBV動能策略",
    docContent: obvDoc,
    timezoneAdvice: "OBV 指標在 60 分鐘 (H1) 最能體現「主力資金」的進出意圖。建議在 H1 作為進場參考時，同步觀察日線 (D1) 的 OBV 趨勢。若 D1 處於長期底背離吸籌期，則 H1 的真突破勝率大幅提升。",
  ...
  },
  {
    ...
    docContent: cjDoc,
    timezoneAdvice: "CJ 策略在 1 小時 (H1) 極具實戰價值，能捕捉到日內波段的明確起漲點。在 15 分鐘 (M15) 時，交叉會非常頻繁，此時必須嚴格遵守「只做與日線方向一致」的訊號。",
  ...
  },
  {
    ...
    title: "MR雙指標共振",
    docContent: mrDoc,
    timezoneAdvice: "MR 策略在 15 分鐘 (M15) 與 30 分鐘 (M30) 非常神準，適合用於捕捉日內強勢攻擊波段。在日線 (D1)，MR 用於判斷動能衰竭。若 M15 出現金叉但日線 RSI 在 50 以下，應以「搶反彈」視之。",
  ...
  },
  {
    ...
    title: "KD隨機指標策略",
    docContent: kdDoc,
    timezoneAdvice: "KD 指標對時間極敏感。在週線 (W1) 或日線 (D1) 具有極高波段參考價值；在 15 分鐘 (M15) 等短時區，容易發生鈍化，必須搭配趨勢指標 (如 MA20) 過濾。",
  ...
  },
  {
    ...
    title: "MFI資金流便覽",
    docContent: mfiDoc,
    timezoneAdvice: "MFI 在日線 (D1) 非常穩健，用於判別大資金進盤與離巢。在 1 小時 (H1) 或 15 分鐘 (M15) 反應迅速，常用於捕捉情緒極點。建議 H1 出現超賣時進場，但須確保 D1 趨勢仍向上。",
  ...
  },
  {
    ...
    timezoneAdvice: "一目均衡表在日線 (D1) 與週線 (W1) 最有效。如果在 15 分鐘或 1 小時圖使用，CMF 的噪音會淹沒所有訊號。",
