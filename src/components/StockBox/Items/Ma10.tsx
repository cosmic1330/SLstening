    ...
    <Tooltip
      title={
        <TooltipContent
          label="MA10"
          ma={ma10}
          deduction_value={ma10_deduction_value}
          tomorrow_deduction_value={ma10_tomorrow_deduction_value}
          deduction_time={ma10_deduction_time}
          tomorrow_deduction_time={ma10_tomorrow_deduction_time}
          lastPrice={lastPrice}
        />
      }
      arrow
