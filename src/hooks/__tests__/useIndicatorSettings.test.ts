...
describe('useIndicatorSettings', () => {
  ...
  it('should return default settings initially', () => {
    ...
    expect(result.current.settings.ma20).toBe(20);
  });
  ...
  it('should load settings from localStorage if available', () => {
    ...
    expect(result.current.settings.ma20).toBe(20); // Default preserved
  });
  ...
  it('should update settings and save to localStorage', () => {
    ...
    const saved = JSON.parse(localStorage.getItem('slitenting-indicator-settings') || '{}');
